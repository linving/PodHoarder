...
public class CircularSeekBar extends View {
...

    {
        ...
        circleColor.setColor(getResources().getColor(R.color.colorPrimary)); // Set default
        // progress
        // color to holo
        // blue.
        // black
        circleRing.setColor(getResources().getColor(R.color.windowBackground));// Set default background color to Gray

        innerColor.setColor(getResources().getColor(R.color.windowBackground));
